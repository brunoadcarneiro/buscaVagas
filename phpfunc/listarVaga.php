...
$result_user = "SELECT * FROM tbl_vaga WHERE status_vaga='A' ORDER BY id_vaga DESC LIMIT $inicio, $qnt_result_pg";
		...
		<tbody>
			...
			?>
				<tr>
					...
					<td>R$ <?php echo $row_vaga['bolsa']; ?></td>
					...
					<td align="center">
						...
						<button type="button" class="btn btn-primary view_vaga" id="<?php echo $row_vaga['id_vaga']; ?>" title="Candidatar a Vaga"><i class="fas fa-check" aria-hidden="true"></i></button>
					</td>
				</tr>
			<?php
			} ?>
