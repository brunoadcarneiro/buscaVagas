			...
			<div class="conteudo">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="visulUsuarioModalLabel">Detalhes de Candidatos</h5>
				...
				<script>
					...
					function listarUser(pagina, qnt_result_pg) {
						...
						$.post('../phpfunc/listarCandidato.php', dados, function(retorna) {
					...
					$(document).ready(function() {
						$(document).on('click', '.view_data', function() {
							...
							if (user_id !== '') {
								...
								$.post('../phpfunc/visualizarCandidatos.php', dados, function(retorna) {
